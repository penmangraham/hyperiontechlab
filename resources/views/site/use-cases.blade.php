        ...
        <div class="section-bg">
            ...
            <div class="flex justify-center pb-[59px] px-5">
                <p class="text-center text-16 md:text-18 text-color-14 dark:text-white font-normal mt-3 w-[700px] break-words font-Figtree">
                    {!! $useCase == 0 ? __('No templates found under the categories.') : __('The space of more than 30 built in uses templates to guide and get into running fixed time based on the way you work .
', ['x' => '<span class="text-color-E2">' . Modules\OpenAI\Entities\UseCase::useCaseCount() . '</span>']) !!}
                </p>
            </div>
        </div>
        <div class="9xl:px-[310px] 8xl:px-40 lg:px-20 md:px-10 px-5 pb-16">
            ...
            <div class="rounded-[40px] mt-[31px] relative get-started-for-free text-center">
                <p class="text-center text-36 md:text-48 text-color-14 font-bold pt-[26px] md:pt-12 font-RedHat break-words px-[26px] lg:px-5">{{ __('Ready to take your content game to the next level?') }}</p>
