    ...
    <div class="dark:bg-color-14 -mt-[74px]">
        ...
        @if(count($packages) != 0)
            <div class="lg:mt-[52px] mt-8">
                <p class="text-color-14 dark:text-white font-bold text-center font-RedHat 6xl:text-32 text-28 xl:w-[700px] xl:px-0 px-5 mx-auto">
                    {{ __('All prices are listed in USD. Plans that include unlimited words are governed by our Fair Use Policy.') }}</p>
            ...
            <div class="lg:mt-[170px] mt-[90px] relative">
                ...
                <div class="relative">
                    ...
                    <p class="mt-3 lg:px-16 md:px-10 px-5 font-Figtree text-color-14 dark:text-white font-normal text-center lg:text-18 text-16 xl:w-[660px] px-5 xl:px-0 mx-auto">
                        {{ __('Our plans strike the ideal balance of affordability, features, and performance. Explore our options to discover the plan that meets your needs best.') }}
                    </p>
        ...
        <div class="9xl:px-[310px] 8xl:px-40 lg:px-16 md:px-10 px-5 lg:mt-[120px] py-[52px] lg:pb-16 dark:bg-color-14 text-center">
            <div class="rounded-[40px] get-started-for-free">
                <p class="text-center text-36 md:text-48 text-color-14 font-bold pt-[26px] md:pt-12 px-[26px] lg:px-5 font-RedHat">{{ __('Ready to take your content game to the next level?') }}</p>
                <p class="text-center text-16 md:text-18 text-color-14 font-normal px-[26px] sm:px-5 mt-4 md:mt-5 break-words xl:w-[775px] mx-auto font-Figtree">{{ __('Are you ready to elevate your content game?') }}</p>
                ...
                <div class="relative flex justify-center w-max mx-auto">
                    <img class="mx-auto 2xl:w-full xl:w-[700px] lg:w-[580px] bottom-0 hidden lg:block z-10 neg-transition-scale" src="{{ asset('Modules/OpenAI/Resources/assets/image/content4.png') }}">
